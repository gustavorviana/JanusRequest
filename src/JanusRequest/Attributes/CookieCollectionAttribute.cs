...
{
    /// <summary>
    /// Attribute used to indicate that a property contains a collection of HTTP cookies.
    /// The property value is resolved in the following order:
    /// <list type="number">
    ///   <item><see cref="ICookieCollectionConvertible"/> - uses <see cref="ICookieCollectionConvertible.ToCookieCollection()"/></item>
    ...
    /// If the property value is null, no cookies are sent.
    /// </summary>
    [AttributeUsage(AttributeTargets.Property)]
    public class CookieCollectionAttribute : Attribute
    {
    }
}
